...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports {PWM}]; #IO_L5N_T0_D07_14 Sch=ja[1]
#set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports {MISO}]; #IO_L4N_T0_D05_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports {sclk}]; #IO_L9P_T1_DQS_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports {SS_N[0]}]; #IO_L8P_T1_D11_14 Sch=ja[4]
...
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports {VN}]; #IO_L1N_T0_AD4N_35 Sch=ain_n[15]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports {VP}]; #IO_L1P_T0_AD4P_35 Sch=ain_p[15]
